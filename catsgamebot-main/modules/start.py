...
from config import users_collection, logger, SUPPORT_CHAT_URL, UPDATES_CHANNEL_URL, MAINTENANCE_MODE, ADMIN_IDS
...
async def send_welcome(message: Message):
    ...
    text = (
        ...
        f"┣ 🌊 <b>Болото</b> — стройте и развивайтесь\n"
